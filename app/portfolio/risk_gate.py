...
class MasterRiskGateReasonCode(StrEnum):
    ...
    RESERVATION_RECONCILIATION_UNAVAILABLE = "RESERVATION_RECONCILIATION_UNAVAILABLE"
    RESERVATION_RECONCILIATION_INCONSISTENT = "RESERVATION_RECONCILIATION_INCONSISTENT"
