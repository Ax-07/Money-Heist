...
export function BacktestLauncher() {
  ...
  const selectPreview=(next:DatasetPreview)=>{
    ...
    if(preset){
      setForm(current=>({...current,qtyStep:preset.qtyStep,minQty:preset.minQty,minNotional:preset.minNotional,maxQty:preset.maxQty,marketMaxLeverage:preset.maxLeverage}));
    }
